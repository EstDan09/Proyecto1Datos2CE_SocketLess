...
execute_process(
  COMMAND "/usr/bin/git" show-ref "4.5.0"
  WORKING_DIRECTORY "/home/esteban/raylib-cpp-4.5.0/include/_deps/raylib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/esteban/raylib-cpp-4.5.0/include/_deps/raylib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/esteban/raylib-cpp-4.5.0/include/_deps/raylib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
